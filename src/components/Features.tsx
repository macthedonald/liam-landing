      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Advanced Intelligence, <br className="hidden sm:block" />Industry-Smart Strategy
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Liam uses cutting-edge AI to analyze trends, audience behavior, and release performance—adapting to your unique goals.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Liam learns from each release, improving recommendations and strategies the more you use it."
            index={0}
          />
          <FeatureCard
            ...
            description="Communicate in natural language. Liam understands context and delivers insights and actions with clarity."
            index={1}
          />
          <FeatureCard
            ...
            description="From DSP submissions to campaign rollouts, Liam handles complex tasks with speed and accuracy."
            index={2}
          />
          <FeatureCard
            ...
            description="Liam tracks real-time trends, platform shifts, and audience engagement to keep your strategy ahead."
            index={3}
          />
          <FeatureCard
            ...
            title="Data Security"
            description="Your data stays protected with enterprise-grade security, giving you full control and peace of mind."
            index={4}
          />
          <FeatureCard
            ...
            description="Whether it’s planning a release or activating a campaign, Liam helps manage tasks so you can stay focused on the music."
            index={5}
          />
        </div>
      </div>
