  ...
  const stepsData = [
    {
      ...
      description: "Apply for early access and get prioritized onboarding to start optimizing your music releases.",
      image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "02",
      title: "Onboarding & Setup",
      description: "We’ll tailor Liam to your label or artist needs—syncing your catalog, goals, and current workflow.",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "03",
      title: "Platform Integration",
      description: "Connect your DSPs, marketing tools, and data sources so Liam can operate as your digital co-pilot.",
      image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "04",
      title: "Smart Optimization",
      description: "With every release, Liam learns and adapts—improving strategy, automating tasks, and helping you scale.",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=800&q=80"
    }
  ];
    ...
    <section className="py-20 bg-white relative" id="how-it-works" ref={sectionRef}>
      ...
      <div className="section-container">
        <div className="text-center mb-16 opacity-0 fade-in-stagger">
          ...
          <h2 className="section-title mb-4">How Liam Integrates Into Your Workflow</h2>
          <p className="section-subtitle mx-auto">
            A seamless four-step process from sign-up to smart automation.
          </p>
        </div>
