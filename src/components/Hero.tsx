      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Liam: your AI powered <br className="hidden sm:inline" />label assistant.
            </h1>
            ...
            >
               All-in-one AI-driven platform that helps independent artists and labels plan, execute, and scale their music careers like the majors. 
            </p>
